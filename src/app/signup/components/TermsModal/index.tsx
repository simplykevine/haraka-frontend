        ...
        <div className="bg-[#091227] border border-[#9FF8F8] rounded-lg shadow-2xl p-8 w-full max-w-xl max-h-[80vh] overflow-y-auto relative">
          ...
          <div className="bg-[#0B182F] border-l-4 border-[#9FF8F8] p-4 mb-6 rounded-r">
            ...
            <p className="text-white/70 text-xs mt-3">
              Also read our{' '}
              <span
                className="text-[#9FF8F8] cursor-pointer hover:underline"
                onClick={(e) => {
                  e.stopPropagation();
                  setPrivacyOpen(true);
                }}
          ...
          <div className="space-y-5 text-white text-base">
            ...
            <div>
              <h3 className="text-xl mb-2 text-[#9FF8F8] font-semibold">3. User Responsibility and Appropriate Reliance</h3>
              <p className="text-white/90 leading-relaxed">
                You are responsible for how you interpret and use Zeno outputs. Outputs should be 
